...
namespace GC_7
{
    public partial class Form1 : Form
    {
        ...
        {
            label2.Text = $" Linia: {textBox1.Text[0] - 48},{textBox1.Text[1] - 48} este inside poligon: \n";
            if (EsteInPoligon(textBox1.Text[0] - 48 - 1 ,textBox1.Text[1] - 48 - 1))
                label2.Text += " Yes";
            else
                label2.Text += " No";
        }
        ...
        {
            label2.Text = $" Punctul: {textBox1.Text[0] - 48} este convex: \n";
            if (EsteVarfConvex(textBox1.Text[0] - 48 - 1))
                label2.Text += " Yes";
            else
                label2.Text += " No";
        }
